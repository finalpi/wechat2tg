const enUS = {
  ...
  'ai.help.context': '/ai -n <count> [extra instruction]  Use a custom context message count for this request',
  'ai.help.context_config': '/ai context <count>  Save the default context message count',
  ...
  'ai.error.invalid_context_limit': 'Please enter a valid context message count, for example: /ai context 20',
  'ai.context_saved': 'Default AI context message count saved as {{count}}',
